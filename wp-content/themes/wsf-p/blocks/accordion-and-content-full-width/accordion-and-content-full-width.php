...
<style>
.careermap-area .news-search-form {
    height: 60px;
...
.careermap-area .news-search-form label[for=search] input {
    width: 100%;
    border: 0;
}

.careermap-area .news-search-form label[for=search] input:focus-visible {
    outline: none;
}

.careermap-area .news-search-form input[type=submit] {
    flex: 0 0 auto;
    border-radius: 50%;
    padding: 0;
...
.careermap-area .news-search-form input,
select,
textarea {
    border: 0;
    outline: none;
